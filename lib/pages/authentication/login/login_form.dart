...
class LoginFormState extends State<LoginForm> {
  ...
  void _submit() async {
    ...
    try {
      http.Response userLogin =
          await UserService().login(_emailCtrl.text, _passCtrl.text);
    ...
    return Form(
      ...
      child: ListView(
        ...
        children: [
          ...
          _buildButton(theme,
              label: isValidating ? 'Validating...' : 'Sign In', onTap: _submit),
        ],
      ),
    );
  }
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: isValidating
                ...
                : [const Color(0xFF0A0A0A), const Color(0xFF161618)], // Login and signUp btn
          ),
          boxShadow: [
            BoxShadow(
